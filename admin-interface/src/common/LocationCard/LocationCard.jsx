...
export default function LocationCard({layout}) {
  return (
    <>
    {layout === "location" && (<div className="location-card-container">
      <div className="location-header">
        <Avatar className="location-avatar">R</Avatar>
        <h1 className="vl-subheading f-700">Monument Impire Fx Organization</h1>
      </div>
    ...
    {layout === "user" && (<div className="location-card-container">
      <div className="location-header">
        <Avatar className="location-avatar">R</Avatar>
        <h1 className="vl-subheading f-700">Monument Impire Fx Organization</h1>
      </div>
