				...
				<div className="card-body">
					...
					<div className="d-flex flex-row">
						...
						<div className="row mr-auto">
							...
							<ul>
								...
								<li>{formatDate(reviewShipment.shipmentDate)}</li>
							</ul>
						</div>
						<div className="row mr-auto">
							<ul>
							...
							<ul>
								...
								<li>{formatDate(reviewShipment.estimateDeliveryDate)}</li>
							</ul>
						</div>
					</div>
					...
					<div className="d-flex flex-row justify-content-between">
						...
						<ul>
							...
							<li>{formatDate(reviewShipment.products[0].manufacturingDate)}</li>
						</ul>
						<ul>
							<li className="bold">Expiry Date</li>
							<li>{formatDate(reviewShipment.products[0].expiryDate)}</li>
						</ul>
						<ul>
					...
					<div className="d-flex justify-content-between">
						...
						<div className="d-flex flex-row">
							<button className="btn-primary btn mr-2" onClick={onEdit}>
								<img src={Pen} width="15" height="15" className="mr-3" alt="Edit" />
								<span>EDIT</span>
							</button>
