    ...
    (req, res) => {
        checkToken(req, res, async result => {
            if (result.success) {
              logger.log(
                'info',
                '<<<<< TrackTraceService < TrackController < fetchGoodsByID  : token verified successfullly, querying data by key',
              );
        
              permission_request = {
                result: result,
                permissionRequired: requiredPermissions.fetchGoodsByID,
              };
              ...
              logger.log(
                'warn',
                '<<<<< TrackTraceService < TrackController < fetchGoodsByID  : refuted token',
              );
    ...
    (req, res) => {
        checkToken(req, res, async result => {
            if (result.success) {
              logger.log(
                'info',
                '<<<<< TrackTraceService < TrackController < fetchTracking  : token verified successfullly, querying data by key',
              );
        
              permission_request = {
                result: result,
                permissionRequired: requiredPermissions.fetchTracking,
              };
              checkPermissions(permission_request, async permissionResult => {
                if (permissionResult.success) {
                    try {
              ...
              logger.log(
                'warn',
                '<<<<< TrackTraceService < TrackController < fetchTracking  : refuted token',
              );
              res.status(403).json(result);
            }
          });
    ...
    (req, res) => {
        checkToken(req, res, async result => {
            if (result.success) {
              logger.log(
                'info',
                '<<<<< TrackTraceService < TrackController < fetchTemp  : token verified successfullly, querying data by key',
              );
        
              permission_request = {
                result: result,
                permissionRequired: requiredPermissions.fetchTemp,
              };
              checkPermissions(permission_request, async permissionResult => {
                if (permissionResult.success) {
                    try {
              ...
              logger.log(
                'warn',
                '<<<<< TrackTraceService < TrackController < fetchTemp  : refuted token',
              );
              res.status(403).json(result);
            }
          });
    ...
    async (req, res) => {
        checkToken(req, res, async result => {
            if (result.success) {
              logger.log(
                'info',
                '<<<<< TrackTraceService < TrackController < track  : token verified successfullly, querying data by key',
              );
        
              permission_request = {
                result: result,
                permissionRequired: requiredPermissions.track,
              };
              checkPermissions(permission_request, async permissionResult => {
                if (permissionResult.success) {
                    try {
              ...
              logger.log(
                'warn',
                '<<<<< TrackTraceService < TrackController < track  : refuted token',
              );
              res.status(403).json(result);
            }
          });
