      ...
      <ul >
        ...
        <li className={(url === '/orders' || url === '/neworder') ? '' : ''}>
          <Link to="/orders" className="d-inline-block">
            <img src={OrderSelectedIcon } alt="Orders" />
            <span className="ml-2">  Orders </span>
          </Link>
        </li>

        <li className={(url === '/inventory'|| url === '/newinventory'|| url === '/addproduct'|| url === '/productlist/all') ? '' : ''}>
          <Link to="/inventory" className="d-inline-block">
            <img src={InventorySelectedIcon} alt="Inventory" />
        ...
        <li className={(url === '/shipments' || url === '/newshipment'|| url === '/transactionHistory') ? '' : ''}>
         ...
         <li className={(url === '/trackAndTrace') ? '' : ''}>
          <Link to="/trackAndTrace" className="d-inline-block">
