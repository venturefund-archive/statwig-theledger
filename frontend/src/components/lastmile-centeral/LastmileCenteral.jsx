	...
	return (
		<div className="LastmileCenteral--Grid-layout">
			<div className="LastmileCenteral--table-wrapper">
				...
				{TableSwitch === "today" && <CenteralTodayTable t={t} vaccinationList={todaysVaccinationList} />}
				{TableSwitch === "total" && <CenteralTotalTable t={t} vaccinationList={vaccinationList} />}
				{TableSwitch === "units" && <CenteralUnitsTable t={t} unitsUtilized={unitsUtilized} />}
			</div>
			<div className="LastmileCenteral--filter-wrapper">
				<Filterbar t={t} tableType={TableSwitch} setFilters={setFilters} {...props} />
			</div>
		</div>
	);
}
