...
export default function Instock({ inStock, inStockFilters, reportWarehouse, setInstockType, setInstockId, t }) {
          ...
          <TableHead>
            <TableRow>
              <TableCell className="mi-custom-tableHead mi-first-cell-padding">
                <Filter filters={inStockFilters} filterKey={"productCategory"} title={t("product_category")} setStockType={setInstockType} setStockId={setInstockId} />
              </TableCell>
              <TableCell className="mi-custom-tableHead">
                <Filter filters={inStockFilters} title={t("product_name")} filterKey={"productName"} setStockType={setInstockType} setStockId={setInstockId}/>
              </TableCell>
              {Distributor && (
                <TableCell className="mi-custom-tableHead">
                  <Filter
