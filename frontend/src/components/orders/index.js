...
import Order from '../../assets/icons/Order ID.png';
import truck from '../../assets/icons/truckthree.svg';
import { useDispatch, useSelector } from 'react-redux';
import { getPOs, resetPOs } from '../../actions/poActions';
import Totalshipments from "../../assets/icons/Delivery Location.png";
...
const Orders = props => {
  ...
  const headers = {
    ...
    img5: <img src={Totalshipments} width="16" height="14" />,
  };
  ...
  return (
    <div className="orders">
      ...
      <div className="full-width-ribben mt-3">
