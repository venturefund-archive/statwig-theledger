                ...
                <div className='row'>
                  <div className='col-md-6 com-sm-12'>
                    <div className='name form-group'>
                      ...
                      <div
                        className={`line ${errors.type && touched.type ? "border-danger" : ""
                          }`}
                      >
                        <Select
                ...
                <div className='row'>
                  <div className='col-md-6 com-sm-12'>
                    <div className='form-group'>
                      ...
                      <div>
                        <input
                          className={`line orgName ${errors.fromOrg && touched.fromOrg
                            ? "border-danger"
                            : ""
                            }`}
                          type='text'
                  ...
                  <div className='col-md-6 com-sm-12'>
                    <div className='name form-group'>
                      ...
                      <div className='orgV border-0'>{values.fromOrg}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className='row'>
                  <div className='col-md-6 com-sm-12'>
                    <div className='name form-group'>
                      ...
                      <div
                        className={`line ${errors.toOrgLocRegion && touched.toOrgLocRegion
                          ? "border-danger"
                          : ""
                          }`}
                      >
                ...
                <div className='row'>
                  <div className='col-md-6 com-sm-12'>
                    <div className='name form-group'>
                      ...
                      <div
                        className={`line ${errors.toOrgLocCountry && touched.toOrgLocCountry
                          ? "border-danger"
                          : ""
                          }`}
                      >
                ...
                <div className='row'>
                  <div className='col-md-6 com-sm-12'>
                    <div className='form-group'>
                      ...
                      <div>
                        <input
                          className={`line orgName ${errors.toOrg && touched.toOrg ? "border-danger" : ""
                            }`}
                          type='text'
                          id='organizationName'
                          name='toOrg'
                ...
                <div className='row'>
                  <div className='col-md-6 com-sm-12'>
                    <div className='name form-group'>
                      ...
                      <div>
                        <input
                          className={`line orgName ${errors.toOrgLoc && touched.toOrgLoc
                            ? "border-danger"
                            : ""
                            }`}
                          type='text'
