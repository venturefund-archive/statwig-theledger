...
const routes = (
  <Switch>
    ...
    <Route
      path="/updateStatus/:id/:returnToView?"
      component={requireAuth(UpdateStatus)}
    />
    <Route
    ...
    <Route
      path="/lastMile-Track"
      component={requireAuth(LastmileTrackingContainer)}
    />
    <Route
      path="/lastMile-Centeral"
      component={requireAuth(LastmileCenteralContainer)}
    />
    ...
    <Route
      path="/network"
      component={requireAuth(NetworkingContainer, {
        distributor: true,
        governingBody: true,
      })}
    />
    ...
    <Route
      ...
      component={requireAuth(Dashboard, {
        adminComponent: { adminComponent: true },
      })}
    />
    <Route
    ...
    <Route
      path="/statwig/roles"
      component={requireAuth(Configuration, { adminComponent: true })}
    />

    {/* Admin Organization */}
    <Route
      path="/org/dashboard"
      component={requireAuth(OrgDashboard, { adminComponent: true })}
    />
    <Route
      path="/org/manage-users"
      component={requireAuth(Users, { adminComponent: true })}
    />
    <Route
